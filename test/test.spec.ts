...
describe("test", () => {
  ...
  it("should store prototype-like record keys as data", () => {
    const version = defineVersionHList(
      hCons(
        {
          version: 1,
    ...
    expect(
      Object.prototype.hasOwnProperty.call(objectsSlot.v, "__proto__"),
    ).toBe(true);
    expect(
      Object.prototype.hasOwnProperty.call(objectsSlot.v, "constructor"),
    ).toBe(true);
    expect(
      Object.prototype.hasOwnProperty.call(objectsSlot.v, "prototype"),
    ).toBe(true);

    const stripped = stripSlot(objectsSlot) as Record<
      string,
      { value: number }
    >;
  ...
  it("should merge JSON-imported prototype-like record keys as data", () => {
    const version = defineVersionHList(
      hCons(
        {
          version: 1,
