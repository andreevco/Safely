...
type TestState = z.output<typeof schema>;
...
describe('createWriteProxy', () => {
    it('supports TypeScript object rest and spread patterns on drafts', () => {
        ...
        storage.update(draft => {
            ...
            expect(Object.prototype.hasOwnProperty.call(draft.users, 'bob')).toBe(true);
            expect(Object.prototype.hasOwnProperty.call(draft.users, 'alice')).toBe(false);
    ...
    it('supports descriptor and Object.assign write patterns on drafts', () => {
        ...
        storage.update(draft => {
            ...
            const descriptorValue = descriptor?.value as TestState['users'][string] | undefined;
            expect(descriptorValue?.name).toBe('Carol');
        });
